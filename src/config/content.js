...
export const experience = [
  {
    ...
    range: 'Present',
    responsibilities: [
      'Designed and maintained scalable data pipelines using Spark orchestrated via Apache Airflow and deployed on GCP (BigQuery, Cloud Storage) to process over 100 million records daily, accelerating customer insights delivery',
      'Set up and operationalized MOSTLY AI\'s synthetic data platform in a GCP environment, enabling early-stage data exploration and pipeline development while ensuring GDPR compliance by replicating statistical properties and business logic of sensitive datasets for data engineering and advanced analytics',
      'Contributed to the migration of on-premise Hadoop systems to GCP, utilizing Dataproc, Dataform, and BigQuery to modernize telecom data infrastructure and reporting. This initiative reduced infrastructure and maintenance costs by 20% while enhancing scalability and ensuring GDPR compliance',
      'Enabled data democratization by building BigQuery based analytical datasets for use in tools like Looker and MicroStrategy',
      'Customized ETL pipeline templates using the Pipeline Generator framework (Java), following a "Convention over Configuration" approach to meet business-specific data requirements',
    ],
    certifications: [],
  },
];
